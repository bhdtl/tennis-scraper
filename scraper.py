...
log("🔌 Initialisiere Neural Scout (V92.0 - Multi-Venue Intelligence)...")
...
def get_last_name(full_name):
    # Einfache Version für schnelle Checks
...
def get_name_tokens(full_name):
    """
    Zerlegt einen Namen in seine Bestandteile (Tokens) für robustes Matching.
...
def sanitize_timestamp(dirty_ts):
    """Rettet kaputte Zeitstempel aus der DB."""
...
# =================================================================
# INTELLIGENT COURT RESOLUTION (Multi-Venue Support)
# =================================================================
...
async def find_best_court_match_smart(scraped_tour_name, db_tours, p1_name, p2_name):
    ...
    if not candidates:
        ...
        # 2. AI Disambiguation
        log(f"   🤔 Ambiguous Venue for {scraped_tour_name} ({len(candidates)} hits). Asking AI...")
...
# =================================================================
# SCAPING & VERIFICATION (V91.0 Logic)
# =================================================================
...
async def update_past_results():
    log("🏆 Checking for Results (V91 Token-Match)...")
...
async def run_pipeline():
    log(f"🚀 Neural Scout v92.0 Starting...")
